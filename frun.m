...
img = imread('images\Fd\image_0102.jpg');
...
img2 = imread('D:\sem5\me\term\images\Fd\image_0120.jpg');
[bboxes,scores] = detect(Fdetector,img2);
% bboxes = Bounding Boxes which surrounds Face -Rectangle Box
% Scores = Confidence that is how sure a Detector is for identifying Human Face
...
img3 = imread('D:\sem5\me\term\images\Fd\image_0175.jpg');
[bboxes,scores] = detect(Fdetector,img3);
% bboxes = Bounding Boxes which surrounds Face -Rectangle Box
% Scores = Confidence that is how sure a Detector is for identifying Human Face
