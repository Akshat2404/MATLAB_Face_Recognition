...
[bboxes,scores] = detect(Edetector,img);
...
[bboxes,scores] = detect(Edetector,img2);
% bboxes = Bounding Boxes which surrounds Face -Rectangle Box
% Scores = Confidence that is how sure a Detector is for identifying Human Face
...
img3 = imread('D:\sem5\me\term\images\Fd\image_0180.jpg');
[bboxes,scores] = detect(Edetector,img3);
% bboxes = Bounding Boxes which surrounds Face -Rectangle Box
% Scores = Confidence that is how sure a Detector is for identifying Human Face
